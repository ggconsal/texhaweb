...
class OptionsControllerTest < ActionController::TestCase
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post :create, option: { area_id: @option.area_id, opt_desc: @option.opt_desc, opt_titulo: @option.opt_titulo }
    end
  ...
  test "should update option" do
    patch :update, id: @option, option: { area_id: @option.area_id, opt_desc: @option.opt_desc, opt_titulo: @option.opt_titulo }
    assert_redirected_to option_path(assigns(:option))
  end
